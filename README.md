...
- [📖 hello-rails-front-end](#-hello-react-front-end)
...
**The hello-react-front-end** is a mobile web application where user can fetch the greetings.
...
1. Download or clone this [repostory](git@github.com:omwomo/hello-react-front-end.git).
...
- Clone this [repository](git@github.com:omwomo/hello-react-front-end.git) to your desired folder:

- Run this command in your command line interface:

```sh
  cd [YOUR FOLDER]
  git git@github.com:omwomo/hello-react-front-end.git
...
Feel free to check the [issues page](https://github.com/omwomo/hello-react-front-end/issues).
...
If you like this project, kindly drop a start ⭐️ for the [repository](git@github.com:omwomo/hello-react-front-end-.git);
